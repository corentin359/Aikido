<div class="jumbotron">
    <h2 class="text-center" class="embed-responsive">
        <a href="index.php?p=accueil.show&club=AÏKIDO CEVENNES LE VIGAN">
            <img class="img-rounded" src="images/logos/logoACV.png" style= "width:100px;height:100px;"></a>
        <a href="index.php?p=accueil.show&club=<?= App::getClub() ?>"><?= App::getClub()?></a>
        <a href="index.php?p=accueil.show&club=ARTS MARTIAUX VALLERAUGUE">
        ...
        <div id="myCarousel" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="item active">
                    <img src="images/acceuil/acceuil1.jpg" alt="Aïkido" style=" max-width: 100%; width: auto; height: auto; vertical-align: middle; ">
                    <div class="container">
                ...
                <div class="item">
                    <img src="images/acceuil/acceuil2.jpg" alt="Aïkido" style=" max-width: 100%; width: auto; height: auto; vertical-align: middle; ">
                    <div class="container">
                        <div class="carousel-caption">
                            <!-- du contenu ici -->
                        </div>
                ...
                <div class="item">
                    <img src="images/acceuil/acceuil3.png" alt="Aïkido" style=" max-width: 100%; width: auto; height: auto; vertical-align: middle; ">
                    <div class="container">
                        <div class="carousel-caption">
                            <!-- du contenu ici -->
                        </div>
